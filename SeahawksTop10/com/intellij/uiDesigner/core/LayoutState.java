...
public final class LayoutState {
   ...
   public LayoutState(GridLayoutManager layout, boolean ignoreInvisibleComponents) {
      ...
      this.myComponents = (Component[])((Component[])componentsList.toArray(new Component[componentsList.size()]));
      this.myConstraints = (GridConstraints[])((GridConstraints[])constraintsList.toArray(new GridConstraints[constraintsList.size()]));
